...
public class SECTR_Hibernator : MonoBehaviour 
{
	...
	void _UpdateComponents()
	{
		...
		{
			Behaviour[] behaviors = HibernateChildren ? GetComponentsInChildren<Behaviour>() : GetComponents<Behaviour>();
		...
		{
			Rigidbody[] bodies =  HibernateChildren ? GetComponentsInChildren<Rigidbody>() : GetComponents<Rigidbody>();
		...
		{
			Collider[] colliders =  HibernateChildren ? GetComponentsInChildren<Collider>() : GetComponents<Collider>();
		...
		{
			Renderer[] renderers =  HibernateChildren ? GetComponentsInChildren<Renderer>() : GetComponents<Renderer>();
